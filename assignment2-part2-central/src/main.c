...
#define BUTTON1_SERVICE_CHARACTERISTIC_UUID 0x0001
#define BUTTON2_SERVICE_CHARACTERISTIC_UUID 0x0002
...
static struct bt_uuid* search_service_uuid = BT_UUID_DECLARE_128(ASSIGNMENT2_SERVICE_UUID);
// static struct bt_uuid* search_characteristic_uuid = BT_UUID_DECLARE_16(_SERVICE_CHARACTERISTIC_UUID);
